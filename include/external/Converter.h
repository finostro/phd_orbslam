...
public:
    ...
    static Sophus::SE3<float> toSophusf(const cv::Mat& T);
    static Sophus::SE3<double> toSophusd(const cv::Mat& T);
    static Sophus::Sim3f toSophusf(const g2o::Sim3& S);
    static Sophus::Sim3d toSophusd(const g2o::Sim3& S);
};
